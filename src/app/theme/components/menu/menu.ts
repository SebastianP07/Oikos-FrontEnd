...
export const verticalMenuItems = [ 
    ...
    new Menu (3, 'UI Features', null, null, 'computer', null, true, 15),
    ...
    new Menu (16, 'Mailbox', '/mailbox', null, 'email', null, false, 15),
    new Menu (17, 'Chat', '/chat', null, 'chat', null, false, 15),
    new Menu (20, 'Form Controls', null, null, 'dvr', null, true, 15), 
    ...
    new Menu (30, 'Tables', null, null, 'view_module', null, true, 15),
    ...
    new Menu (40, 'Pages', null, null, 'library_books', null, true, 15),
    ...
    new Menu (55, 'Schedule', '/schedule', null, 'event', null, false, 15),
    new Menu (66, 'Maps', null, null, 'map', null, true, 15),
    ...
    new Menu (70, 'Charts', null, null, 'multiline_chart', null, true, 15),
    ...
    new Menu (81, 'Drag & Drop', '/drag-drop', null, 'mouse', null, false, 15),  
    new Menu (85, 'Material Icons', '/icons', null, 'insert_emoticon', null, false, 15),  
    new Menu (140, 'Level 1', null, null, 'more_horiz', null, true, 15),
    ...
    new Menu (200, 'External Link', null, 'http://themeseason.com', 'open_in_new', '_blank', false, 15),
    new Menu (201, 'Gestión Menu', '/dynamic-menu', null, 'format_list_bulleted', null, false, 15),
    new Menu (202, 'Users', '/users', null, 'supervisor_account', null, false, 15), 
]
